...
func (nc *NoteCreate) SetMessage(s string) *NoteCreate {
	nc.mutation.SetMessage(s)
	return nc
}

// SetTag sets the "tag" field.
func (nc *NoteCreate) SetTag(s string) *NoteCreate {
	nc.mutation.SetTag(s)
	return nc
}

// SetNillableTag sets the "tag" field if the given value is not nil.
func (nc *NoteCreate) SetNillableTag(s *string) *NoteCreate {
	if s != nil {
		nc.SetTag(*s)
	}
	return nc
...
func (nc *NoteCreate) check() error {
	if _, ok := nc.mutation.Message(); !ok {
		return &ValidationError{Name: "message", err: errors.New(`ent: missing required field "Note.message"`)}
	}
